...
class sv997 {
    ...
    public sv997(String code, String name, String lop) {
        this.code = code;
        this.name = name;
        this.lop = lop;
    }
...
public class b214_DiemDanh1 {
    ...
    public static void main(String[] args) {
        ...
        int q = n;
        ArrayList<sv997> arr = new ArrayList<>();
        while (n-- != 0) {
            String code = sc.nextLine();
            String name = sc.nextLine();
            String lop = sc.nextLine();
            sv997 x = new sv997(code, name, lop);
            arr.add(x);
        }
        while (q-- > 0) {
...
// public static void main(String[] args) {
// Scanner sc = new Scanner(System.in);
// ArrayList<sv997> arr1 = new ArrayList<>();
// int n = Integer.parseInt(sc.nextLine());
// int q = n;
// while (n-- > 0) {
// String code = sc.nextLine();
// String name = sc.nextLine();
// String lop = sc.nextLine();
// arr1.add(new sv997(code, name, lop));
// }
